package com.example.crud_note_adit.adapter
...
import com.example.crud_note_adit.DbHelper
import com.example.crud_note_adit.DetailBuku
import com.example.crud_note_adit.model.Modelbuku
import com.example.crud_note_adit.R

import com.example.crud_note_adit.screen.UpdateDataBukuActivity
    ...
    override fun onBindViewHolder(holder: BukuViewHolder, position: Int) {
        ...
        holder.btnEdit.setOnClickListener(){
            //perlu bikin 1 lagi activity edit
                val intent = Intent(holder.itemView.context, UpdateDataBukuActivity::class.java).apply {
